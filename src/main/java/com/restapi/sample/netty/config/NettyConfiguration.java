package com.restapi.sample.netty.config;

import com.restapi.sample.netty.socket.NettyChannelInitializer;
...
public class NettyConfiguration {
    ...
    @Value("${netty.server.boss-count}")
    private int bossCount;

    @Value("${netty.server.worker-count}")
    private int workerCount;

    @Value("${netty.server.keep-alive}")
